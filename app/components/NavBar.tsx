                        ...
                        >
                            ...
                            <div className="flex flex-col h-full overflow-y-auto px-6 py-6">
                                ...
                                <div className="mb-8 flex-shrink-0">
                                    <p className="text-[#D9D9D9] text-xl font-Satoshi font-thin mb-4 leading-relaxed">
                                ...
                                <div className="flex text-[#9D9D9D] items-center justify-between mt-auto pt-6 flex-shrink-0">
                                    <a href="https://t.me/glmchannel" target="_blank" rel="noopener noreferrer" className="text-[#9D9D9D] hover:text-gray-300 transition" aria-label="Telegram">
                                        <svg width="38" height="32" viewBox="0 0 35 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <a href="https://www.facebook.com/glmhq" target="_blank" rel="noopener noreferrer" className="text-[#9D9D9D] hover:text-gray-300 transition" aria-label="Facebook">
                                        <svg className="w-9 h-9" fill="currentColor" viewBox="0 0 24 24" aria-label="Facebook">
                                    ...
                                    <a href="https://www.instagram.com/stories/gospellabourhq" target="_blank" rel="noopener noreferrer" className="text-[#9D9D9D] hover:text-gray-300 transition" aria-label="Instagram">
                                        <svg className="w-9 h-9" fill="currentColor" viewBox="0 0 24 24" aria-label="Instagram">
                                    ...
                                    <a href="https://x.com/ApostleJoseph_I" target="_blank" rel="noopener noreferrer" className="text-[#9D9D9D] hover:text-gray-300 transition" aria-label="Twitter/X">
                                        <svg className="w-9 h-9" fill="currentColor" viewBox="0 0 24 24" aria-label="Twitter/X">
